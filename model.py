...
def clean(name):
    # Extract only numeric characters from the name (this captures the number within parentheses)
    return re.sub(r'\D', '', name)  # \D matches any non-digit character and removes it
